...
char * pointer_encode_client(struct rsc_header * header, struct rsc_regs * regs, unsigned int * buffer_size);
char * out_pointer_encode_client(unsigned int p_location, unsigned int p_count, unsigned int * buffer_size);
